...
import reportsFixedAssetsHome from "@/assets/reports-fixed-assets-home.jpg";

const ReportsFixedAssets = () => {
  return (
    <DashboardLayout>
...
export default ReportsFixedAssets;
